...
Il repository include anche il workflow GitHub Actions **Windows build**, che produce lo ZIP come artifact scaricabile.
...
| `scripts/build_windows_app.ps1` | Build Windows `.exe` in formato one-folder e ZIP. |
