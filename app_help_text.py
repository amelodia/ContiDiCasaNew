...
• Girata conto/conto: per una girata con secondo conto Cassa, il campo Nota può essere preimpostato con «Aut », la data breve e uno spazio finale, per agevolare la digitazione; al focus, se il testo è quello modello, il cursore si posiziona dopo lo spazio finale. Per giroconti verso/da VIRTUALE la nota non viene preimpostata a «Giroconto».
• Dopo ogni inserimento andato a buon fine i default del modulo vengono ripristinati (anche se scegli «Concludi immissione» prima di passare ai Movimenti), così la nota non ripropone testualmente la registrazione precedente.
...
SCHEDA «VERIFICA»
Confronto tra movimenti registrati ed estratto conto in PDF per il conto scelto. Avvio sessione, immissione manuale o automatica delle voci, chiusura con salvataggi previsti. Non uscire dalla scheda Verifica con una sessione ancora aperta: usa «Chiudi verifica» (o l’equivalente) prima di cambiare pagina; è comunque consentito consultare PDF generati da Stampa/anteprima dove previsto.
...
Pagine riservate a evoluzioni future: al momento possono risultare in preparazione.
