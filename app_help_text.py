...
SCHEDA «REGISTRAZIONI PERIODICHE»
Elenco e creazione di registrazioni ricorrenti gestite dal programma (scadenze, cadenze, materializzazione nei movimenti). È una scheda dedicata nella barra principale, distinta da «Nuove registrazioni».
